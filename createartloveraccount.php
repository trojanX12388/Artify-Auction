  ...
  $defaultpic = $firstname[0];
    ...
    try {
        ...
        $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC);
              ...
              if($pass == $cpass ){
              $insertlogin = "INSERT INTO Login (Email, Password, Verification_code) VALUES ('$email','$encrypted_password', '" . $verification_code . "')";
              ...
              header('location:failedartloveraccount.php');
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/createartloveraccount7.css">
  ...
  <!-- Account Panel -->
    ...
    <div class="title">
     ...
     <!-- CREATE ART LOVER ACCOUNT  -->
    <div class="container">
    <form action="createartloveraccount.php" method="post" enctype="multipart/form-data">
        <div class="title">
        </div>
        <div class="artlover">
        <img src="css/createartloveraccount/signup.png">
        </div>
        ...
        <div class="option">Email Address</div>
        <div class="input-box underline">
        ...
        <div class="option">Confirm Password</div>
        <div class="input-box underline">
