...
if(isset($_POST['remove'])){
  ...
  $rsql = "DELETE FROM Account WHERE AccountID = '$removeacc'";
  $results = sqlsrv_query($conn, $rsql);

  };

$showpass1 = $_SESSION['showpass1'];
  
if(isset($_POST['showpass1'])){
  $_SESSION['showpass1'] = 1;
  header('location:adminartcollectorreg.php');
  };

  
if(isset($_POST['hidepass1'])){
  $_SESSION['showpass1'] = 0;
  header('location:adminartcollectorreg.php');
  };
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;height: 700px; overflow-x:auto;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-user-circle"></i>Art Collector Registry</b></h5>
  </header>
<br>
<br>  
<br>
...
<input type='submit' name='showpass1' value='Show Pass' class="center"></input>
<input type='submit' name='hidepass1' value='Hide Pass' class="center"></input>
</form>
