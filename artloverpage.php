            ...
            ?>
              ...
              <span><?php echo $_SESSION['email'] ?></span>
                    ...
                    <div style=" height: 90px;overflow-x:auto;overflow-y:auto;">
                      ...
                      $notifID = $account['AccountID'];

                    $tsql = "SELECT * FROM ArtNotification 
                    WHERE (AccountID LIKE '%" . $notifID . "%'
                    ...
                    $no = 0;
                      while ($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)) { 
                        ...
                        ?>
                        <tr>
                        <form action='artloverpage.php' method='post' enctype='multipart/form-data'>
                          <td><?= $no ?></td>
                          <td>
                          <td>
...
<button class="open-button" type="submit" name="chat" style="z-index:2000">Chat</button>
