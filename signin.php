...
if(isset($_POST['login'])){
  ...
  $stmt = sqlsrv_query($conn, $tsql);
     ...
     if($row['Email'] == $email && $row['Password'] == $pass )
       ...
       $_SESSION['artloverid'] = $row['AccountID'];
        header('location:artloverpage.php');
       }
       elseif($pass != $row['Password'] ){
        header('location:failedartloverlogin.php'); 
        }
};
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/signinform3.css">
  ...
  <!-- Account Panel -->
    ...
    <form action="signin.php" method="post" enctype="multipart/form-data">
        ...
        <div class="option">Login with your Email and Password</div>
   ...
   <form action="signinartist.php" method="post" enctype="multipart/form-data">
        ...
        <div class="option">If you are an artist and want to login to your dashboard, please sign in below.</div>
        <div class="input-box button">
        ...
        <div class="option1">Don't have account yet?</div>
   ...
   <div class="admincontainer">
        <div class="title">
        <img src="css/signin/admin.png">
        </div>
        <div class="artist">
        </div>
        <div class="applyonline">
          <a href="adminlogin.php"><i class="fab fa-facebook-f"></i>Log In</a>
        </div>
  </div>
