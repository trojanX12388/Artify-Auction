  ...
  <div class="account_modal" role="dialog" id="account">
    ...
    <div class="artcontent" >
                    <table>   
                            ...
                            <form action='viewartartist.php' method='post' enctype='multipart/form-data'>

                            <td>
                                <tc><img src='arts_watermarked/".$art['WaterImage1']."' alt='' class='card-img' oncontextmenu='return false;'></tc>
                                <br>
                                ...
                                <div class = 'table1'>  
                                <h5>".date_format($art['Date_Release'],'F d Y')."</h5> 
                                
                                <h4>ART ID: ".$art['ID']."</h4>  
                                <h4>".$art['Art_Name']."</h4>              
                                <p>". mb_strimwidth($art['Description'], 0, 35, "...")."</p>
                                <br>
                                <p>".$art['Dimension']."</p> 
                                <br>   
                                <h4>ARTIST | </h4>                          
                                ...
                                <h4>VENUE | </h4>
                                <h8>". mb_strimwidth($art['Venue'], 0, 300, "...")."</h8>
                                <br>
                                <br>   
                                <h4>ONLINE AUCTION UNTIL: </h4>
                                ...
                                <br>
                                    ...
                                    <input type='hidden' name='artname' value='".$art['Art_Name']."'>
                                         ...
                                         <input type='submit' id='btn1' name='bid' value='Place Bid' class ='bid'>
                            </form>  
                                    </div>
                                    <div class='enter'>
                             ...
                             <div class='botlayer'>
                                    ...
                                    <input type='submit' name='wishlist' value='Add To Wishlist' class ='bid' disabled>
                            </form>
                               </div>
...
function stopPrntScr() {
      ...
      <script>
        ...
        alert('Bidding is only available for Art Lover Users. Please sign in as Art Lover to Bid.');
        });
      </script>
